...
export const WIDTH_CELLS: number = Math.floor( MAX_WIDTH / CELL_SIZE);
export const HEIGHT_CELLS: number = Math.floor(MAX_HEIGHT / CELL_SIZE);

export const TOTAL_CELLS: number = 0;
export const FALLBACK_LIMIT: number = 50;
export const SLEEP_DELAY: number = 50;

export const DEFAULT_SHAPE_OBJECTS: Shape[] = [
    new Shape("Block",
        [
