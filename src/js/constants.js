...
// const CELL_SIZE = 100;
const WIDTH_CELLS = MAX_WIDTH / CELL_SIZE;
const HEIGHT_CELLS = MAX_HEIGHT / CELL_SIZE;

const TOTAL_CELLS = (MAX_WIDTH/CELL_SIZE) * (MAX_HEIGHT/CELL_SIZE);
const FALLBACK_LIMIT = 50;
const SLEEP_DELAY = 50;
...
export {MAX_WIDTH, MAX_HEIGHT, CELL_SIZE, WIDTH_CELLS, HEIGHT_CELLS, TOTAL_CELLS, DEFAULT_SHAPE_OBJECTS, FALLBACK_LIMIT, SLEEP_DELAY };
